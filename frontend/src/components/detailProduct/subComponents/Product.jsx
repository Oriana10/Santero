...
const Product = ({ productName, productDescription, price }) => {
  ...
  return (
    <div className={styles.productContainer}>
      <img className={styles.productImg} src={Pizza} alt={productName} />
      ...
      <section className={styles.productInfo}>
        ...
        <div className={styles.btnContainer}>
          <div className={styles.quantityContainer}>
            <button type="submit" className={`${styles.btnQuantity} ${styles.reduce}`} onClick={reduceQuantity}>-</button>
            <div className={styles.quantity}><p>{productQuantity}</p></div>
            <button type="submit" className={`${styles.btnQuantity} ${styles.add}`} onClick={addQuantity}>+</button>
          </div>
